...
export default async function CustomerInvoicesPage() {
  ...
  const invoices = await prisma.invoice.findMany({ where: { customerId: customer.id }, orderBy: { createdAt: "desc" }, select: { id: true, number: true, filename: true, size: true, createdAt: true, order: { select: { reference: true } } } });
