  ...
  return <div className="space-y-6">
    <section className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
      ...
      <div className="mt-2 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        ...
        <div className="rounded-2xl bg-slate-50 px-5 py-3 text-right"><p className="text-[10px] font-black uppercase tracking-wide text-slate-400">Volume total TTC</p><p className="mt-1 text-xl font-black text-slate-950">{formatMoney(dashboard.totalTtc)}</p></div>
      </div>
    </section>
