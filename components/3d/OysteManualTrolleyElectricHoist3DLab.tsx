...
const PFI_MODEL_PATH = "/models/chariot-manuel-palan-electrique.glb";
const MESH_MAPPING_STORAGE_KEY = "oyste-3d-lab:manual-trolley-electric-hoist:mesh-mapping";
const DEV_PRESET_STORAGE_KEY = "oyste-3d-lab:manual-trolley-electric-hoist:developer-preset";
const EXTRACTION_PRESET_STORAGE_KEY =
  "oyste-3d-lab:manual-trolley-electric-hoist:mesh-022-extraction";
const MESH_VALIDATION_STORAGE_KEY = "oyste-3d-lab:manual-trolley-electric-hoist:mesh-validation";
const FREE_EXTRACTIONS_STORAGE_KEY = "oyste-3d-lab:manual-trolley-electric-hoist:free-extractions";
const FUNCTIONAL_GROUPS_STORAGE_KEY = "oyste-3d-lab:manual-trolley-electric-hoist:functional-groups";
...
type ExtractionPreset = {
  version: 1;
  model: "PFI125_MANUAL_TROLLEY_ELECTRIC_HOIST";
  sourceMesh: "mesh-022";
...
function PfiModel({
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (
        preset.version !== 1 ||
        preset.model !== "PFI125_MANUAL_TROLLEY_ELECTRIC_HOIST" ||
...
export default function OysteManualTrolleyElectricHoist3DLab() {
  ...
  useEffect(() => {
    try {
      ...
      if (savedFunctionalGroups) {
        setFunctionalGroups(JSON.parse(savedFunctionalGroups));
      }
            ...
            <div className="relative min-h-[860px] bg-slate-950">
              <div className="pointer-events-none absolute inset-x-0 top-0 z-10 flex items-center justify-between gap-3 p-5">
                <div className="rounded-full border border-white/10 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.28em] text-white/80">
                  OYSTE 3D Lab · Chariot manuel + palan électrique
                </div>
